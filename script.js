...
function adicionarLinhaParagem(motivo = '', tempo = '') {
    ...
    div.style = "display:grid; grid-template-columns: 1fr 60px 30px; gap:5px; margin-bottom:5px;";
    div.innerHTML = `
        ...
        <input type="number" placeholder="Min" value="${tempo}" class="paragem-tempo" style="padding:5px; border-radius:4px; background:#0f172a; color:white; border:1px solid #334155; font-size:11px;">
